...
import Embed from '../Pictures/cloudmp3.mp4'
...
const CloudComp = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Cloud Computing and IoT</h1>
      </div>
...
<video autoPlay  loop  type="video/mp4" controls className='container ' src={Embed} alt="embed" />
