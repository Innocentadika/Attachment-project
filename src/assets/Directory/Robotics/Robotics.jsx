...
import Robotic from '../Pictures/robotic2.png'
...
const Robotics = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Robotics</h1>
      </div>
...
<img  className='container ' src={Robotic} alt="embed" />
