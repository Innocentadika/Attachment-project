...
import Fish from '../Pictures/floatingfarm2.png'
...
const Farm = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Floating Farm</h1>
      </div>
...
<img  className='container ' src={Fish} alt="embed" />
