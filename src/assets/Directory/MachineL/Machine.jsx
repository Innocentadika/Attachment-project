...
import Machine from '../Pictures/machinelearning2.png'
...
const MachineL = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Machine Learning</h1>
      </div>
...
<img  className='container ' src={Machine} alt="embed" />
