...
import Embed from '../Pictures/spaceE.png'
...
const SpaceEng = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Space Engineering</h1>
      </div>
...
<img  className='container ' src={Embed} alt="embed" />
