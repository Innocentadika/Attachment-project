...
import Digital from '../Pictures/digitaldesign.png'
...
const Design = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>Digital Design</h1>
      </div>
...
<img  className='container ' src={Digital} alt="embed" />
