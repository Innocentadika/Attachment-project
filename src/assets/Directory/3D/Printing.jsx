...
import Printer from '../Pictures/3Dprinting1.png'
...
const Printing = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 style={{color: '#f51655', fontSize:'2rem', padding: 2}} className='lg:ml-10'>3D Printing</h1>
      </div>
...
<img  className='container ' src={Printer} alt="embed" />
